...
class CaptionChunkContractTest(unittest.TestCase):
    ...
    def test_more_than_four_fragments_are_rejected_as_context_thinning(self):
        chunks = [
            {"text": "가격이", "start_sec": 0.0, "end_sec": 0.8},
            {"text": "아니라", "start_sec": 0.8, "end_sec": 1.6},
            {"text": "우리 집에", "start_sec": 1.6, "end_sec": 2.4},
            {"text": "맞는 걸", "start_sec": 2.4, "end_sec": 3.2},
            {"text": "권했습니다.", "start_sec": 3.2, "end_sec": 4.0},
        ]
