...
class CleanupDryRunTest(unittest.TestCase):
    def setUp(self):
        ...
        self.write("HTML_APPROVAL.json", b"html approval")
        self.write("MP4_RENDER_APPROVAL.json", b"render approval")
    ...
    def test_scanner_reports_only_allowlisted_candidates_without_mutating_files(self):
        ...
        self.assertIn("output/001_demo/HTML_APPROVAL.json", protected_paths)
        self.assertIn("output/001_demo/MP4_RENDER_APPROVAL.json", protected_paths)
