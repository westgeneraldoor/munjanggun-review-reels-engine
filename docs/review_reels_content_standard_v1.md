...
CTA를 뺀 본문 문장 중 **가장 짧은 문장이 평균 길이의 75%를 넘으면 실패**합니다.
문장이 모두 비슷한 길이면 이야기가 아니라 낭독이 됩니다.

- 실패: 모든 문장이 17~27자로 균일한 대본 (최단/평균 0.77)
- 통과: `여기는 달랐습니다.`처럼 확 짧은 한 문장이 긴 문장 사이에 들어간 대본 (0.36)

**종결어미 반복은 기준이 아닙니다.** 골든 샘플도 `~습니다`를 여섯 번 연속 씁니다.
읽는 맛을 만드는 것은 어미가 아니라 길이의 낙차입니다.
